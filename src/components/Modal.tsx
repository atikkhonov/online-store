  ...
  return (
    ...
    >
      ...
      <div className="modal-header">
          <div className="modal__title">ЖИДКОСТЬ FRUIT SHAKE (SALT) МАНГО СМОРОДИНА 30мл/20мг</div>
          <div className="modal-buttons">
            <button className="modal__button modal__button-favorite">
              <p>В избранное</p>
            ...
            <button className="modal__button modal__button-compare">
              <p>Сравнить</p>
              <svg width="26" height="26" viewBox="0 0 26 26" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className="modal-content">
          <div className="modal-left-block">
            <img src="./images/image.jpg" alt="jija)" />
          </div>
          <div className="modal-right-block">
            <div className="modal__price">470 ₽/шт</div>
            <div className="modal-order-block">
              <div className="amount-block">
                <button className="button-plus">+</button>
                <div className="items__count">13</div>
                <button className="button-minus">-</button>
              </div>
              <button className="button-confirm">Добавить в корзину</button>
            </div>
            <div className="modal__item_name">ЖИДКОСТЬ FRUIT SHAKE (SALT) МАНГО СМОРОДИНА</div>
            <p>Характеристики:</p>
            <div className="modal--items">
              <div className="modal__item"><span>Бренд</span> — DABBLER</div>
              <div className="modal__item"><span>Вкус</span> — Газировка Крем Сода</div>
              <div className="modal__item"><span>Крепость</span> — 20 мг</div>
            </div>
          </div>
        </div>
      </div>
