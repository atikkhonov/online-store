      ...
      <div className="card">
        <div className="card-header">
          <div className="card-more-buttons">
            ...
            >
              {
                favoriteProducts.find((findItem) => findItem.id === product.id ) 
                ? 
                <svg width="38" height="38" viewBox="0 0 38 38" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <rect width="38" height="38" rx="5" fill="#34FFAA"/>
                  <path d="M19 33.25L17.6205 32.0112C13.9643 28.6854 11.0371 25.7837 8.83896 23.3061C6.64076 20.8285 5.54166 18.3174 5.54166 15.7728C5.54166 13.764 6.22019 12.0843 7.57724 10.7339C8.93429 9.38353 10.611 8.70833 12.6073 8.70833C13.7512 8.70833 14.884 8.98176 16.0055 9.52862C17.127 10.0755 18.1252 10.9739 19 12.2238C19.9869 10.9739 21.0075 10.0755 22.0618 9.52862C23.116 8.98176 24.2263 8.70833 25.3927 8.70833C27.389 8.70833 29.0657 9.38353 30.4228 10.7339C31.7798 12.0843 32.4583 13.764 32.4583 15.7728C32.4583 18.3174 31.3592 20.8285 29.161 23.3061C26.9628 25.7837 24.0357 28.6854 20.3795 32.0112L19 33.25ZM19 30.605C22.4094 27.4801 25.1684 24.7681 27.2769 22.4691C29.3853 20.17 30.4396 17.938 30.4396 15.7728C30.4396 14.2997 29.9629 13.0888 29.0096 12.1401C28.0563 11.1915 26.8507 10.7172 25.3927 10.7172C24.2712 10.7172 23.2169 11.0632 22.23 11.7551C21.2431 12.4471 20.4356 13.4403 19.8075 14.7349H18.1589C17.5532 13.4403 16.7513 12.4471 15.7532 11.7551C14.755 11.0632 13.7064 10.7172 12.6073 10.7172C11.1269 10.7172 9.91562 11.1915 8.97354 12.1401C8.03146 13.0888 7.56041 14.2997 7.56041 15.7728C7.56041 17.938 8.61465 20.17 10.7231 22.4691C12.8316 24.7681 15.5906 27.4801 19 30.605Z" fill="white"/>
                </svg>
                : 
                <svg width="38" height="38" viewBox="0 0 38 38" fill="none" xmlns="http://www.w3.org/2000/svg">
